...
def init_db():
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS pedidos (
            ...
            data VARCHAR(20), cliente VARCHAR(200), projeto VARCHAR(200), validade VARCHAR(20),
            tipo_venda VARCHAR(50), forma_pagamento VARCHAR(50), parcelas INT,
            subtotal DOUBLE, desconto_pct DOUBLE, receita DOUBLE,
            cmv DOUBLE, imposto DOUBLE, taxa_pgto DOUBLE, comissao DOUBLE,
            frete DOUBLE, montagem DOUBLE, resultado DOUBLE, margem DOUBLE,
            itens TEXT
        )
    """)
    conn.commit()
